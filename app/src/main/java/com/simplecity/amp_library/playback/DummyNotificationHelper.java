...
class DummyNotificationHelper {
    ...
    private static String channelId = "channel_dummy";
    ...
    void showDummyNotification(Service service) {
        ...
        ensureNotificationChannelExists(notificationManager, service);
    ...
    private void ensureNotificationChannelExists(NotificationManager notificationManager, Service service) {
        NotificationChannel channel = notificationManager.getNotificationChannel(channelId);
        if (channel == null) {
            channel = new NotificationChannel(channelId, service.getString(R.string.app_name), NotificationManager.IMPORTANCE_DEFAULT);
